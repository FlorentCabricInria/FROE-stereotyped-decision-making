...
<div id="row">
    <h1>Task Training part 3 (final).</h1>
    <p>Task instruction remains the same, but we will add two features to help you make what you consider to be the best decision. These features will help you to explore the full range of decisions you can make. <br> Three piece of information will be available for you:</p>
    <div style="border: 2px solid #f80b0b;display: inline-block">
        <button id="addCurrentGenderPayGap"> Add the first piece of information: Gender pay gap</button> <span id="LineGenderPG" hidden="true">The current gender pay gap is <span id="TestGenderPG"> 5% (women lower)</span> !<span id="" style="color: darkred"> <-- Move the first slider and see what's happening! This value is updated in real time!</span>
